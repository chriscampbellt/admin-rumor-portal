    ...
    <div className="px-6 py-8 2xl:px-8">
      <div className="mb-8 flex flex-wrap items-center gap-6 rounded-[24px] bg-white p-6 font-diatype">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mb-2 font-sans text-sm font-normal leading-relaxed text-ui-neutralSurfaceOnColor md:text-lg 2xl:text-[20px]">
                ...
                bigg...Revolve Festival kicks off the 2023 <br />
                Coachella festival season in style. Making a show-stopping
                return to the desert with its bigg...Revolve Festival kicks off
                the 2023 Coachella festival season in style. Making a
                show-stopping return to the desert with its bigg...Revolve
                Festival kicks off the 2023 Coachella festival season in style.
                Making a show-stopping return to the desert with its bigg...
              </p>
        ...
        <div className="relative flex items-center gap-2 self-start">
          ...
          <CommonButton className="rounded-full border border-ui-lightGreyBorder bg-transparent text-sm text-ui-neutralSurfaceOnColor hover:bg-ui-neutralInputBg">
